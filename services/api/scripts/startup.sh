...
aws-secrets-manager.sh shopping-cart/api/development/${AWS_SM_ENV} -- ./node_modules/.bin/sequelize db:seed:all --config config/config.js --seeders-path ${NODE_ENV}-seeders/
